...
export default function Home() {
  ...
  return (
    <>
      <div className="max-w-screen-xl mx-auto overflow-hidden p-6 m-6">
        {/* Hero Section with Background Image */}
        <section className="relative p-10 rounded-xl flex items-center bg-cover bg-center bg-no-repeat overflow-visible"
        ...
        >
          ...
          <div className="relative z-10 w-2/3 text-white">
            ...
            <button className="mt-4 bg-yellow-500 text-black px-6 py-2 rounded-lg">
              Explore Now
            </button>
          </div>
